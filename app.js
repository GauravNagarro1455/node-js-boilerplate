...
app.get('/view-profile', passportConfig.isAuthenticated, grantAccess('readOwn', 'profile'), profileController.getProfile );

app.get('/view-profile/:id', passportConfig.isAuthenticated, grantAccess('readAny', 'profile'), profileController.getProfileById );
